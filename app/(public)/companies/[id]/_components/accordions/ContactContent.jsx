    ...
    <div className="rounded-md border p-4 sm:p-5 bg-white">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          <p className="text-sm font-medium">Contact Inbox {company?.name}</p>
          <p className="text-xs text-muted-foreground leading-6">
            If you’re not sure exactly what you need here, send this company a
            custom message. You can talk about your project needs, price, and
            timeline to get started on your project.
          </p>
