        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-stretch">
          ...
          <Card className="border border-black rounded-xl p-4 sm:p-6 h-full flex flex-col">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm sm:text-base text-black leading-relaxed">
                تبحث عن خدمات موثوقة؟ استكشف الشركات ومقدمي الخدمات التي تناسب
                احتياجاتك.
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border border-black rounded-xl p-4 sm:p-6 h-full flex flex-col">
            <CardHeader className="pb-4">
              ...
              <CardDescription className="text-sm sm:text-base text-black leading-relaxed">
                هل تريد النمو والوصول إلى المزيد من العملاء؟ تواصل مع المستخدمين
                والموردين عبر منصتنا.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4 flex-1 flex flex-col">
              <ul className="space-y-3">
